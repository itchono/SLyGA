...
for i = 1:2
    ...
    fprintf(fid, "Achieved error of %g (vs tolerance %g) after %d orbits (%.f seconds = %.0f days) with %d solver steps\n", ...
        final_err, cfg.tol, num_orbits, t(end), t(end)/86400, length(t));
